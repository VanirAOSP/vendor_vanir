...
PRODUCT_BUILD_PROP_OVERRIDES += BUILD_DISPLAY_ID=JSS15Q BUILD_ID=JSS15Q BUILD_VERSION_TAGS=release-keys USER=android-build BUILD_EST_DATE=$(shell date +"%s")
...
-include vendor/vanir/sepolicy/sepolicy.mk
